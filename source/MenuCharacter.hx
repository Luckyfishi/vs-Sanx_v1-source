...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'sanx' => new CharacterSetting(40, 170, 1.5, false),
		'simon' => new CharacterSetting(-40, 0, 0.8, false)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('sanx', "Sanx idle dance BLACK LINE", 24);
		animation.addByPrefix('simon', "Simon idle Black Lines", 24);
